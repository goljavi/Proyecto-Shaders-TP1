...
Shader "Custom/SHADER"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 break23_g4 = tex2D( _Shorts, uv_Shorts );
			float textureX45_g4 = break23_g4.x;
			float4 filterR49_g4 = saturate( ( ColorA32 + ( 1.0 - textureX45_g4 ) ) );
			float textureY46_g4 = break23_g4.y;
			float4 filterG54_g4 = saturate( ( ColorB31 + ( 1.0 - textureY46_g4 ) ) );
			float textureZ47_g4 = break23_g4.z;
			float4 filterB58_g4 = saturate( ( ColorC27 + ( 1.0 - textureZ47_g4 ) ) );
			float4 Green38 = ( ( filterR49_g4 * filterG54_g4 * filterB58_g4 ) * i.vertexColor.g );
...
/*ASEBEGIN
Version=16700
-1913;114;1903;735;1406.104;326.3247;1;True;True
...
Node;AmplifyShaderEditor.ColorNode;26;-1698.357,-250.5845;Float;False;Property;_ColorC;Color C;7;0;Create;True;0;0;False;0;0,0,0,0;1,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;25;-1690.64,-496.1023;Float;False;Property;_ColorB;Color B;6;0;Create;True;0;0;False;0;0,0,0,0;0,0.1684002,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;22;-1691.185,-745.7742;Float;False;Property;_ColorA;Color A;5;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;2;-1347.942,-618.1404;Float;True;Property;_Shirt;Shirt;0;0;Create;True;0;0;False;0;None;4a7cebd7f13201f449e38c6205790a6e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;3;-1353.767,12.37321;Float;True;Property;_Socks;Socks;3;0;Create;True;0;0;False;0;None;4a7cebd7f13201f449e38c6205790a6e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;4;-1360.277,625.9503;Float;True;Property;_Shorts;Shorts;4;0;Create;True;0;0;False;0;None;4a7cebd7f13201f449e38c6205790a6e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;64;-1042.731,662.2502;Float;False;LerpRGB;1;;4;94d4cac60f6f1bd4e892b7050d48710c;0;5;21;FLOAT4;0,0,0,0;False;22;FLOAT4;0,0,0,0;False;24;FLOAT4;0,0,0,0;False;19;FLOAT;0;False;5;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=6F299A7B97ECA43F1C601A12F08F4209A7AE6B49